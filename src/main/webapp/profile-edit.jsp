    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-md-8 col-xs-12">
          <div class="white-box">
            <form class="form-horizontal form-material" action="<c:url value="/profile-edit"/>" method="post" name = >
              <div class="form-group">
                <label class="col-md-12">Tên dự án</label>
                <div class="col-md-12">
                  <select class="form-control form-control-line">
                    <c:forEach var="item" items="${listProjets}">
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text"  class="form-control form-control-line" name="nameJob">
                </div>
              </div>
              <div class="form-group">
                <label class="col-md-12">Ngày bắt đầu</label>
                <div class="col-md-12">
                  <input type="date"  placeholder="dd/MM/yyyy" class="form-control form-control-line" name="startDate">
                </div>
              </div>
              <div class="form-group">
